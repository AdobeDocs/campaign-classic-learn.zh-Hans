...
1) **Android 移动应用程序**
   ...
   [使用 Experience Platform Mobile SDK 配置推送渠道](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/push-channel/configure-push-using-aep-mobile-sdk.html?lang=zh-Hans)
